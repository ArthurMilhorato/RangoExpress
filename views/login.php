...
<head>
    ...
    <title>Login - Rango Express</title>
    <link rel="stylesheet" href="/public/css/style.css">
    <link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><text y='.9em' font-size='90'>🚀</text></svg>">
    <meta name="description" content="Login - Rango Express - Comida rápida e deliciosa">
</head>
<body>
    <div class="auth-container" style="min-height: 100vh; background: linear-gradient(135deg, #8B0000 0%, #DAA520 50%, #FFD700 100%); display: flex; align-items: center; justify-content: center; padding: 20px; position: relative; overflow: hidden;">
        ...
        <div class="auth-card" style="background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px); border-radius: 20px; padding: 40px; box-shadow: 0 20px 60px rgba(0,0,0,0.3); border: 2px solid rgba(218,165,32,0.3); max-width: 450px; width: 100%; position: relative; z-index: 1;">
            <div style="text-align: center; margin-bottom: 30px;">
                ...
                <h1 class="auth-title" style="color: #8B0000; font-size: 2.5rem; font-weight: 700; margin: 0; text-shadow: 2px 2px 4px rgba(0,0,0,0.1);">Rango Express</h1>
                <p style="color: #666; margin: 10px 0 0 0; font-size: 1.1rem;">Comida rápida e deliciosa!</p>
            </div>

            <?php if (isset($_SESSION['success'])): ?>
                <div class="alert alert-success" style="animation: slideInFromTop 0.5s ease-out; background: linear-gradient(135deg, #d4edda, #a8dfbb); color: #155724; padding: 15px 20px; border-radius: 10px; border: 1px solid #c3e6cb; margin-bottom: 20px; font-weight: 600;">
            ...
            <form method="POST" action="/login" style="animation: fadeInUp 0.6s ease-out;">
                ...
                <div class="form-group" style="margin-bottom: 30px;">
                    ...
                    <input type="password" id="password" name="password" class="form-control" required style="width: 100%; padding: 15px; border: 2px solid #DAA520; border-radius: 10px; font-size: 16px; background: #fafafa; transition: all 0.3s ease; box-sizing: border-box;">
                </div>

                <button type="submit" class="btn btn-primary" style="width: 100%; padding: 18px; font-size: 18px; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; border: none; border-radius: 10px; background: linear-gradient(45deg, #8B0000, #DAA520); color: white; cursor: pointer; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(139,0,0,0.3); position: relative; overflow: hidden;">
            ...
            <div class="auth-link" style="text-align: center; margin-top: 25px; padding-top: 20px; border-top: 1px solid rgba(218,165,32,0.3);">
                <p style="margin: 0; color: #666; font-size: 1rem;">
                    Não tem conta?
                    <a href="/register" style="color: #8B0000; text-decoration: none; font-weight: 600; transition: all 0.3s ease; position: relative;">
                        <span style="position: relative; z-index: 1;">Cadastre-se aqui</span>
                        <span style="position: absolute; bottom: -2px; left: 0; width: 0; height: 2px; background: linear-gradient(45deg, #8B0000, #DAA520); transition: width 0.3s ease;"></span>
                    </a>
                </p>
            </div>
        </div>
